document.addEventListener('DOMContentLoaded', () => {
    ...
    document.querySelectorAll('.coming-soon').forEach(link => {
        link.onclick = (e) => {
            ...
            modalContent.innerHTML = `<p style="color: #a0a0a0; margin: 20px 0;">This feature is currently under development. Stay tuned for updates!</p>`;
